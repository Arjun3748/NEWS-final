          ...
          <div style={{ 
            ...
            <div>
              ...
              <p style={{ color: 'rgba(255,255,255,0.8)', lineHeight: 1.6 }}>
                We're committed to bringing you the most relevant and timely news from your community and beyond.
              </p>
            </div>
            <div>
              <h3 style={{ color: '#fff', marginBottom: '1rem' }}>Quick Links</h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                <a href="/admin/login" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none' }}>Admin Login</a>
                <a href="/user/userLogin" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none' }}>User Login</a>
                <a href="/user/terms&Conditions" style={{ color: 'rgba(255,255,255,0.8)', textDecoration: 'none' }}>Terms & Conditions</a>
              </div>
            </div>
            <div>
